...
function PrivacyPolicy() {
  return (
    ...
    >
      ...
      <p>
        When you create or use an Evermore account, we may collect information
        such as your name, username, email address, profile information,
        profile picture, posts, comments, and other information you choose to
        provide.
      </p>

      <h2>2. How We Use Your Information</h2>
      <p>
        We use information to provide and maintain Evermore, manage accounts,
        enable community features, allow users to connect and interact,
        maintain points and achievements, improve the platform, maintain
        security, and communicate important service information.
      </p>
      ...
      <p>
        ...
        through the contact information provided on the website or application.
      </p>

      <h2>10. Changes to This Policy</h2>
      <p>
        We may update this Privacy Policy from time to time. When changes are
        made, we will update the "Last updated" date.
      </p>
